...
RSpec.describe 'activeadmin-react.gemspec' do
  ...
  it 'publishes immutable release metadata' do
    expect(gemspec.metadata).to include(
      ...
      'changelog_uri' => 'https://github.com/scarver2/activeadmin-react/blob/v0.2.0/CHANGELOG.md',
      'documentation_uri' => 'https://github.com/scarver2/activeadmin-react/blob/v0.2.0/README.md',
      'homepage_uri' => 'https://github.com/scarver2/activeadmin-react',
      'rubygems_mfa_required' => 'true',
      'source_code_uri' => 'https://github.com/scarver2/activeadmin-react/tree/v0.2.0'
    )
  end
end
